...
contract DexPair is DexERC20, IDexPair {
    ...
    constructor() DexERC20("DEX LP Token", "DLPT") {
        factory = msg.sender;
    }
    ...
    function mint(address to) external override lock returns (uint256 liquidity) {
        ...
        if (totalSupply == 0) {
            ...
            liquidity = amount0.mul(totalSupply).div(_reserve0).min(amount1.mul(totalSupply).div(_reserve1));
        }
